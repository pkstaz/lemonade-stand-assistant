...
# Configuration
METRICS_URL <- Sys.getenv("METRICS_URL", "http://asistente-cafe:8080/metrics")
...
ui <- page_fillable(
  ...
  titlePanel("☕ Dashboard de guardrails - Cafetería"),

  div(class = "subtitle", "Monitoreo en tiempo real de detecciones y métricas del asistente de café"),
